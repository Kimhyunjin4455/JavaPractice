...
//    }
    ...
    public MemoMain(){
        String url = "jdbc:mysql://localhost:3306/lockEx";
        String user = "root";
        String password = "12349576";
        try {
            this.repository = Repository.newConnection(url, user, password);
        } catch (SQLException throwables) {
            throw new RuntimeException("MySQL 연결실패..ㅜㅜ");
        }
        this.post = new Post(repository);
    }
